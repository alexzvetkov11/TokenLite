...
//            Setting::updateValue('site_logo', 'site_logo');

            if($request->file('site_logo')){
                $fileName = time().'.'.$request->site_logo->getClientOriginalExtension();
                $request->site_logo->move(public_path('images/sitelogo'), $fileName);
                Setting::updateValue('site_logo', $fileName);
//                $setting = Setting::where('field', 'site_logo')->first();
//                if(isset($setting)){
//                    $setting->update([
//                        'value'=>$fileName
//                    ]);
...
//            Setting::updateValue('site_logo', $fileName);
    ...
    public function update_meta(Request $request)
    {
        ...
        if($type == 'tnx_page_meta' || $type == 'kyc_page_meta' || $type == 'user_page_meta' || $type == 'jurisdiction_page_meta' || 'entity_types_page_meta' || 'entity_page_meta' || 'kyci_page_meta' || 'kycr_page_meta' || 'kyct_page_meta') {
