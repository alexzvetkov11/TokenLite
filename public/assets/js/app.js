...
function purchase_form_submit(e = $(".validate-form"), t = !0, n = "ti ti-info-alt") {
    ...
    if (r.length > 0 && ajax_form_submit(r, !1), e(".upload-zone").length > 0) {
        ...
        if (e(".document_proof_of_address").length > 0) {
            var u = new Dropzone(".document_proof_of_address", {
                url: l,
                uploadMultiple: !1,
                maxFilesize: 5.1,
                maxFiles: 1,
            ...
            u.on("sending", function(e, t, n) {
                ...
                cl(n);
                var a = n.message;
                "error" == n.msg ? (alert(a), u.removeFile(t)) : e('input[name="document_proof_of_address"]').val(n.file_name)
            }).on("removedfile", function(t) {
                var n = e('input[name="document_proof_of_address"]').val();
                n.length > 0 && e.post(l, {
                    _token: csrf_token,
                    action: "delete",
                    file: n
                }).done(t => {
                    cl(t), e('input[name="document_proof_of_address"]').val("")
                })
            })
        }
    }
