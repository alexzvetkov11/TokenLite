                    ...
                    <div class="page-nav-wrap">
                        <div class="page-nav-bar justify-content-between bg-lighter">
                            <div class="page-nav w-100 w-lg-auto">
                                <ul class="nav">
                                    ...
                                    <li class="nav-item{{ is_page('kyc-list.approved') ? ' active' : '' }}"><a
                                            class="nav-link" href="{{ route('admin.kycs', 'approved') }}">Approved</a></li>
                            ...
                            {{-- <div class="search flex-grow-1 pl-lg-4 w-100 w-sm-auto">
                                <div class="relative float-right pr-1">
                                    <a href="#" class="btn btn-light-alt btn-sm btn-icon toggle-tigger"> <em
                                    ...
                                    <div
                                        ...
                                        <ul class="dropdown-list dropdown-list-s2">
                                            <li>
                                                <h6 class="dropdown-title">{{ __('Show') }}</h6>
                                            </li>
                                            <li>
                                                <input class="data-filter input-checkbox input-checkbox-sm" type="radio"
                                                    name="tnx-type" id="type10" checked value="">
                                                <label for="type10">{{ __('10') }}</label>
                                            </li>
                                            <li>
                                                <input class="data-filter input-checkbox input-checkbox-sm" type="radio"
                                                    name="tnx-type" id="type20">
                                                <label for="type20">{{ __('20') }}</label>
                                            </li>
                                            <li>
                                                <input class="data-filter input-checkbox input-checkbox-sm" type="radio"
                                                    name="tnx-type" id="type50">
                                                <label for="type50">{{ __('50') }}</label>
                                            </li>
                                        </ul>
                                        <ul class="dropdown-list dropdown-list-s2">
                                            <li>
                                                <h6 class="dropdown-title">{{ __('Order') }}</h6>
                                            </li>
                                            <li>
                                                <input class="data-filter input-checkbox input-checkbox-sm" type="radio"
                                ...
                                <div class="relative float-right pr-1">
                                    <a href="#" class="btn-light-alt btn-sm btn-icon toggle-tigger"> <em
                                            ...
                                            <div class="relative">
                                                ...
                                                <div
                                                    ...
                                                    <ul class="dropdown-list">
                                                        ...
                                                        <li><a
                                                                href="{{ route('admin.export', array_merge(['table' => 'kycs', 'format' => 'entire'], request()->all())) }}">Entire</a>
                                                        </li>
                                                        <li><a
                                                                href="{{ route('admin.export', array_merge(['table' => 'kycs', 'format' => 'minimal'], request()->all())) }}">Minimal</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                ...
                                <form class="adv-search" id="adv-search" action="{{ route('admin.kycs') }}" method="GET"
                                    ...
                                    <div class="adv-search">
                                        <div class="row align-items-end guttar-20px guttar-vr-15px">
                                                    ...
                                                    <div class="input-grp align-items-center bg-white">
                                                        <div class="input-wrap flex-grow-1">
                                                            <input value="{{ request()->get('search') }}"
                                                                ...
                                                                type="text" placeholder="Search by name/id" name="search">
                                                        </div>
                                                        <ul class="search-type">
                                                            <li class="input-wrap input-radio-wrap">
                                                                <input name="by" class="input-radio-select" id="advs-by-uid"
                                                                    value="" type="radio"
                                                                    {{ empty(request()->by) || request()->by != 'name' ? ' checked' : '' }}>
                                                                <label for="advs-by-uid">UID</label>
                                                            </li>
                                                            <li class="input-wrap input-radio-wrap">
                                                                <input name="by" class="input-radio-select"
                                                                    id="advs-by-name" value="name" type="radio"
                                                                    {{ isset(request()->by) && request()->by == 'name' ? ' checked' : '' }}>
                                            ...
                                            <div class="col-sm-4 col-lg-2 col-mb-6">
                                                <div class="input-wrap input-with-label">
                                                    ...
                                                    <select name="state"
                                                        ...
                                                        <option
                                                            {{ request()->get('state') == 'pending' ? ' selected' : '' }}
                                                            value="pending">Pending</option>
                                                        <option
                                                            {{ request()->get('state') == 'missing' ? ' selected' : '' }}
                                                            value="missing">Missing</option>
                                                        <option
                                                            {{ request()->get('state') == 'approved' ? ' selected' : '' }}
                                                            value="approved">Approved</option>
                                                        <option
                                                            {{ request()->get('state') == 'deleted' ? ' selected' : '' }}
                                            ...
                                            <div class="col-sm-4 col-lg-2 col-mb-6">
                                                <div class="input-wrap input-with-label">
                                                    <label class="input-item-label input-item-label-s2 text-exlight">DOC
                                                        TYPE</label>
                                                    <select name="doc" class="select select-sm select-block select-bordered"
                                                        data-dd-class="search-off">
                                                        <option value="">Any Type</option>
                                                        <option {{ request()->get('doc') == 'nidcard' ? ' selected' : '' }}
                                                            value="NID Card">NID Card</option>
                                                        <option {{ request()->get('doc') == 'passport' ? ' selected' : '' }}
                                                            value="passport">Passport</option>
                                                        <option {{ request()->get('doc') == 'driving' ? ' selected' : '' }}
                                                            value="driving">Driving</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-sm-4 col-lg-2 col-mb-6">
                        ...
                        @if (request()->get('filter') || request()->s)
                            <div class="search-adv-result">
                                <div class="search-info">Found <span class="search-count">{{ $kycs->total() }}</span>
                                    Applications.</div>
                                <ul class="search-opt">
                                ...
                                @foreach ($kycs as $kyc)
                                    <tr class="data-item data-item-{{ $kyc->id }}">
                                        <td class="data-col dt-user">
                                            ...
                                            <span
                                                class="lead user-name">{{ _x($kyc->firstName) . ' ' . _x($kyc->lastName) }}</span>
                                            <span class="sub user-id">{{ set_id($kyc->userId) }}</span>
                                        </td>
                                        <td class="data-col dt-doc-type">
                                            <span
                                                class="sub sub-s2 sub-dtype">{{ ucfirst($kyc->documentType) == 'Nidcard' ? 'NID Card' : ucfirst($kyc->documentType) }}</span>
                                        </td>
                                            ...
                                            <div class="relative d-inline-block">
                                                ...
                                                <div class="toggle-class dropdown-content dropdown-content-top-left">
                                                    <ul class="dropdown-list more-menu more-menu-{{ $kyc->id }}">
                                                        <li><a
                                                                href="{{ route('admin.kyc.view', [$kyc->id, 'kyc_details']) }}"><em
                                                                    class="ti ti-eye"></em> View Details</a></li>
                                                        @if ($kyc->status != 'approved')
                                                            <li><a class="kyc_action kyc_approve" href="#"
                                                                    data-id="{{ $kyc->id }}" data-toggle="modal"
                                                                    data-target="#actionkyc"><em
                                                                        class="far fa-check-square"></em>Approve</a></li>
                                                        @endif
                                                        @if ($kyc->status != 'rejected')
                                                            <li><a href="javascript:void(0)"
                                                                    data-current="{{ __status($kyc->status, 'status') }}"
                                                                    data-id="{{ $kyc->id }}" class="kyc_reject"><em
                                                                        class="fas fa-ban"></em>Reject</a></li>
                                                        @endif
                                                        @if ($kyc->status == 'missing' || $kyc->status == 'rejected')
                                                            <li><a href="javascript:void(0)" data-id="{{ $kyc->id }}"
                                                                    class="kyc_delete"><em
                                                                        class="fas fa-trash-alt"></em>Delete</a></li>
                                                        @endif
                                                    </ul>
                                                </div>
                                            </div>
