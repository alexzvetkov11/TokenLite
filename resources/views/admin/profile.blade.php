                    ...
                    <div class="card-innr">
                        ...
                        <div class="nav nav-tabs nav-tabs-line">
                            <ul class="nav mb-0" id="myTab" role="tablist">
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#accountInfo">Login Credentials</a></li>
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#secutity">Security Settings</a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="input-item input-with-label">
                                                    <label for="full-name" class="input-item-label ucap">First Name</label>
                                                    <div class="input-wrap">
                                                        <input class="input-bordered" type="text" value="{{ $user->name }}" placeholder="First name" id="full-name" name="name">
                                                    </div>
                                                </div>{{-- .input-item --}}
                                            </div>
                                            <div class="col-md-6">
