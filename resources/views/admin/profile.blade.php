                    ...
                    <div class="card-innr">
                        ...
                        <div class="nav nav-tabs nav-tabs-line">
                            <ul class="nav mb-0" id="myTab" role="tablist">
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#changePassword">Login Credentials</a></li>
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#personaldata">Personal Data</a></li>
                        ...
                        <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-item input-with-label">
                                                    ...
                                                    <div class="input-wrap">
                                                        <input class="input-bordered" type="email" value="{{ $user->email }}" placeholder="Email Address" id="email-address" name="email" disabled="">
                                                    </div>
                                                </div>{{-- .input-item --}}
                                            </div>
                                            <div class="col-lg-6">
                            ...
                            <div class="tab-pane fade" id="settings">
                                <div class="w-xl-16x">
                                    <h6 class="card-title card-title-sm text-dark">Security Settings</h6>
                                    ...
                                    <div class="col-md-12">
                                        <div class="content-area card">
                                            <div class="">
                                                ...
                                                <p>Two-factor authentication is a method for protection your web account. When it is activated you need to enter not only your password, but also a special code. You can receive this code by in mobile app. Even if third person will find your password, then cant access with that code.</p>
