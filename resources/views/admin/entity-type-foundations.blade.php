    ...
    <div class="row justify-content-center">
        <div class="col-lg-10 col-xl-9">
            ...
            <div class="<!--kyc-form-steps--> card mx-lg-4">
                ...
                <form method="POST" action="{{ isset($foundations)? route('admin.ajax.entype.editFoundations') : route('admin.ajax.entype.addFoundations')}}">
                    @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="input-item input-with-label">
                                        ...
                                        <div class="input-wrap">
                                            ...
                                            value="{{ isset($foundations)? $foundations->members_min : ''}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-item input-with-label">
                                        ...
                                        <div class="input-wrap">
                                            ...
                                            value="{{ isset($foundations)? $foundations->members_max : ''}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <input type="hidden" name="foundationId" value="{{isset($foundations)?$foundations->id:''}}">
