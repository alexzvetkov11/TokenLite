                ...
                <div class="card-head has-aside">
                    ...
                    <div class="card-opt data-action-list d-md-inline-flex">
                        <a href="#" data-toggle="modal" data-target="#addJurisdiction" class="btn btn-auto btn-sm btn-primary" >
                            <em class="fas fa-plus-circle"> </em><span>Add <span class="d-none d-md-inline-block">Entity Jurisdiction</span></span>
                        </a>
                    </div>
                </div>
                                ...
                                <div class="relative d-inline-block">
                                    ...
                                    <div class="toggle-class dropdown-content dropdown-content-top-left">
                                        <ul class="dropdown-list more-menu-{{$en->id}}">
                                            ...
                                            <li><a href="javascript:void(0)" data-uid="{{ $en->id }}" data-type="approve" class="user-form-action user-action"><em class="far fa-check-square"></em>Approve</a></li>
                                            <li><a href="#" data-uid="{{ $en->id }}" data-type="reject" class="user-action front"><em class="fas fa-ban"></em>Reject</a></li>  --}}
                                            <li>
