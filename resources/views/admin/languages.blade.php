    ...
    <div class="modal-dialog modal-dialog-sm modal-dialog-centered">
        <div class="modal-content">
            <div class="popup-body">
                ...
                <form action="{{ route('admin.ajax.lang.action') }}" method="POST" id="lang-settings-update">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="input-item input-with-label">
                                <label class="input-item-label">Default Language</label>
                                <div class="input-wrap input-wrap-switch">
                                    <select class="select select-block select-bordered" name="languages_default">
                                        @foreach($languages as $lang)
                                        <option {{ gws('languages_default') == $lang->code ? 'selected ' : '' }}value="{{ $lang->code }}">{{ $lang->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
    ...
    <div class="modal-dialog modal-dialog-md modal-dialog-centered">
        <div class="modal-content">
            <div class="popup-body">
                ...
                <form class="validate-modern" action="{{ route('admin.ajax.lang.action') }}" method="POST" id="lang-add-new">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="input-item input-with-label">
                                <label class="input-item-label">Language Name</label>
