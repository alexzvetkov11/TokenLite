                                    ...
                                    <div class="d-flex justify-content-between pdt-1x">
                                        <div class="col-md-6">
                                            <div class="input-item input-with-label">
                                                <label for="purpose_type" class="input-item-label">{{__('Currency')}}</label>
                                                <div class="input-wrap">
                                                    <select class="form-control" name="purpose_type" id="purpose_type" data-dd-class="search-on">
                                            ...
                                            @foreach ($shareclasses as $class)
                                                <tr class="data-item ">
                                                    <td class="data-col dt-user">
                                                        <span class="lead user-name">Class {{ $class->class_code }}</span>
                                                    </td>
                                                    <td class="data-col dt-user">
                                                    ...
                                                    <td class="data-col dt-user">
                                                        <span class="lead user-name">{{ $class->authorized_shares }}</span>
                                                    </td>
                                                    <td class="data-col dt-user">
                                                        <span class="lead user-name">{{ floatval($class->authorized_shares)* floatval($class->par_value) }}</span>
                                                    </td>
                                                    <td class="data-col text-right" style="width:70px">
                                                        <div class="relative d-inline-block">
                                                            ...
                                                            <div class="toggle-class dropdown-content dropdown-content-top-left">
                                                                <ul class="dropdown-list more-menu-{{ $class->id }}">
                                                                    <li>
                                                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#editJurisdiction" data-id="{{ $class->id }}" class="user-action front editJurisdiction">
                                                                            <em class="fas fa-edit"></em>Edit
                                                                        </a>
                                                                        <a href="javascript:void(0)" data-uid="{{ $class->id }}" data-type="delete_user" data-url=""
        ...
        <div class="modal-dialog modal-dialog-md modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="popup-body popup-body-md">
                    ...
                    <hr/>
                    <form action="{{ route('user.ajax.entities.add.shareclass') }}" method="POST" class="adduser-form validate-modern"  autocomplete="off">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="input-item input-with-label">
                                    ...
                                    <div class="input-wrap">
                                        <input name="parvalue" id="parvalue" class="input-bordered commadouble" type="text" placeholder="Number">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 class">
                                <div class="input-item input-with-label">
                                    ...
                                    <div class="input-wrap">
                                        <input name="authorizedshares" class="input-bordered percent comma" type="text" placeholder="Percentage">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="input-item input-with-label">
                                    ...
                                    <div class="input-wrap input-wrap-switch">
                                        ...
                                        <input class="input-switch switch-toggle" data-switch="switch-votting-right" type="checkbox" id="chvotingright" name="chvotingright">
                            ...
                            <div class="col-sm-6 class">
                                ...
                                <div class="input-item input-with-label">
                                    ...
                                    <div class="input-wrap">
                                        <input name="votingRightNumber" class="input-bordered commadouble" type="text" placeholder="3 decimal" id="votingRightNumber">
                                    </div>
                                </div>
                                </div>
                            </div>
                            <div class="col-sm-6 chMeetingRight">
                                <div class="input-item input-with-label">
                                    ...
                                    <div class="input-wrap input-wrap-switch">
                                        <span class="align-items-center d-flex pr-3">Yes</span>
                                        <input class="input-switch" name="chMeetingRight" type="checkbox" id="chMeetingRight">
                        ...
                        <div class="row ordinary">
                            <div class="col-sm-6">
                                <div class="input-item input-with-label">
                                    ...
                                    <div class="input-wrap input-wrap-switch">
                                        <span class="align-items-center d-flex pr-3">Yes</span>
                                        <input class="input-switch" name="chReserveRight" type="checkbox" id="chReserveRight" checked>
                        ...
                        <div class="row ordinary">
                            <div class="col-sm-6">
                                <div class="input-item input-with-label">
                                    ...
                                    <div class="input-wrap input-wrap-switch">
                                        <span class="align-items-center d-flex pr-3">Yes</span>
                                        <input class="input-switch" name="chConversionRight" type="checkbox" id="chConversionRight">
                        ...
                        <div class="row ordinary">
                            <div class="col-sm-6">
                                <div class="input-item input-with-label">
                                    <label for="conversionshare" class="input-item-label">{{ __('Conversion Share Class') }}</label>
                                    <select name="conversionshare" id="conversionshare" class="select-block select-bordered" >
                            ...
                            <div class="col-sm-6">
                                <div class="input-item input-with-label">
                                    <label for="conversionratio" class="input-item-label">{{ __('Conversion Ratio') }}</label>
                                    <div class="input-wrap">
                                        <input name="conversionratio" class="input-bordered percent numerical" type="text" placeholder="Number">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-item input-with-label">
                                    ...
                                    <div class="input-wrap input-wrap-switch">
                                        <span class="align-items-center d-flex pr-3">Yes</span>
                                        <input class="input-switch switch-toggle" data-switch="switch-continue" name="continueconversion" type="checkbox" id="continueconversion">
                            ...
                            <div class="row ordinary">
                                <div class="col-sm-6">
                                    <div class="input-item input-with-label">
                                        ...
                                        <div class="input-wrap">
                                            <input class="input-bordered date-picker" type="text" id="start_date" name="start_date" date-format="alt" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="input-item input-with-label">
                                        ...
                                        <div class="input-wrap">
                                            <input class="input-bordered date-picker" type="text" id="end_date" name="end_date" date-format="alt"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="switch-content switch-to-preemption">
                            <div class="row ordinary">
                                <div class="col-sm-6">
                                    <div class="input-item input-with-label">
                                        <label for="pre_emption_apply" class="input-item-label">{{ __('Pre-emption rights applicable to:') }}</label>
                        ...
                        <div class="row preference">
                            <div class="col-sm-6">
                                <div class="input-item input-with-label">
                                    <label for="reserveoption" class="input-item-label">{{ __('Preferred Dividend Calculation') }}</label>
                        ...
                        <div class="row floating">
                            ...
                            <div class="col-sm-6">
                                <div class="input-item input-with-label">
                                    <label for="annual" class="input-item-label">{{ __('Preferential Annual Dividend Rate') }}</label>
                                    <div class="input-wrap">
                                        <input name="annual" id="annual" class="input-bordered percent" type="text" placeholder="Percent">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row preference">
                            ...
                            <div class="col-sm-6">
                                <div class="input-item input-with-label">
                                    ...
                                    <div class="input-wrap input-wrap-switch">
                                        <span class="align-items-center d-flex pr-3">Yes</span>
                                        <input class="input-switch" type="checkbox" id="chParticipating" name="chParticipating">
                        ...
                        <div class="row preference">
                            <div class="col-sm-6 chPerpetual">
                                <div class="input-item input-with-label">
                                    ...
                                    <div class="input-wrap">
                                        <input class="input-bordered date-picker" type="text" id="maturity_date" name="maturity_date" date-format="alt" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 chPerpetual">
                            ...
                            <div class="col-sm-6">
                                <div class="input-item input-with-label">
                                    <label for="settlement" class="input-item-label">{{ __('Conversion Share Class') }}</label>
                                    <select name="settlement"  class="select-block select-bordered" >
                                        <option value="">{{ __('Select Option') }}</option>
                                        <option value="ordinary_rights_voting">{{ __('ordinary_rights_voting') }}</option>
                                        <option value="ordinary_rights_regular_dividend">{{ __('ordinary_rights_regular_dividend') }}</option>
                                        <option value="preference_dividend_rate">{{ __('preference_dividend_rate') }}</option>
                                        <option value="preference_cumulative">{{ __('preference_cumulative') }}</option>
                                        <option value="preference_maturity_type">{{ __('preference_maturity_type') }}</option>
                                        <option value="preference_maturity_date">{{ __('preference_maturity_date') }}</option>
                                        <option value="preference_redemption_rights">{{ __('preference_redemption_rights') }}</option>
                                        <option value="preference_redemption_rate">{{ __('preference_redemption_rate') }}</option>
                                        <option value="preference_redemption_start_date">{{ __('preference_redemption_start_date') }}</option>
                                        <option value="preference_redemption_end_date">{{ __('preference_redemption_end_date') }}</option>
                                        <option value="preference_conversion_rights">{{ __('preference_conversion_rights') }}</option>
                                        <option value="preference_conversion_rate">{{ __('preference_conversion_rate') }}</option>
                                        <option value="preference_conversion_start_date">{{ __('preference_conversion_start_date') }}</option>
                                        <option value="preference_conversion_end_date">{{ __('preference_conversion_end_date') }}</option>
                            ...
                            <div class="col-sm-6">
                                <div class="input-item input-with-label">
                                    <label for="maturityrate" class="input-item-label">{{ __('Conversion Rate') }}</label>
                                    <div class="input-wrap">
                                        <input name="maturityrate" class="input-bordered percent numerical" type="text" placeholder="Number">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row preference">
                            <div class="col-sm-6 chRedemption">
                                <div class="input-item input-with-label">
                                    <label for="maturity_date" class="input-item-label">{{ __('Continuous Redemption Right') }}</label>
                                    <div class="input-wrap input-wrap-switch">
                                        <span class="align-items-center d-flex pr-3">{{ __('Yes') }}</span>
                                        <input class="input-switch" type="checkbox" id="chContinueRedemption" name="chContinueRedemption">
                            ...
                            <div class="col-sm-6 chRedemption">
                                <div class="input-item input-with-label">
                                    <label for="redemptionrate" class="input-item-label">{{ __('Redemption Rate') }}</label>
                                    <div class="input-wrap">
                                        <input name="redemptionrate" class="input-bordered percent numerical" type="text" placeholder="Number">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 chContinueRedemption">
                                <div class="input-item input-with-label">
                                    <label for="redstart_date" class="input-item-label">{{ __('Redemption Rights Start Date') }}</label>
                                    <div class="input-wrap">
                                        <input class="input-bordered date-picker" type="text" id="redstart_date" name="redstart_date" date-format="alt" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 chContinueRedemption">
                                <div class="input-item input-with-label">
                                    <label for="redend_date" class="input-item-label">{{ __('Redemption Right End Date') }}</label>
                                    <div class="input-wrap">
                                        <input class="input-bordered date-picker" type="text" id="redend_date" name="redend_date" date-format="alt" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row preference">
                            <div class="col-sm-6">
                                <div class="input-item input-with-label">
                                    ...
                                    <div class="input-wrap input-wrap-switch">
                                        <span class="align-items-center d-flex pr-3">{{ __('Yes') }}</span>
                                        <input class="input-switch" type="checkbox" id="chPreconversion" name="chPreconversion">
                        ...
                        <div class="row preference">
                            <div class="col-sm-6 chPreconversion">
                                <div class="input-item input-with-label">
                                    <label for="preconversionshare" class="input-item-label">{{ __('Conversion Share Class') }}</label>
                                    <select name="preconversionshare" id="preconversionshare" class="select-block select-bordered" >
                                        <option value="">{{ __('Select Option') }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6 chPreconversion">
                                <div class="input-item input-with-label">
                                    <label for="preconversionrate" class="input-item-label">{{ __('Conversion Rate') }}</label>
                                    <div class="input-wrap">
                                        <input name="preconversionrate" class="input-bordered percent numerical" type="text" placeholder="Number">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row preference">
                            <div class="col-sm-6 chPrecontinue">
                                <div class="input-item input-with-label">
                                    <label for="preconversion_start" class="input-item-label">{{ __('Conversion Rights Start Date') }}</label>
                                    <div class="input-wrap">
                                        <input class="input-bordered date-picker" type="text" id="preconversion_start" name="preconversion_start" date-format="alt" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 chPrecontinue">
                                <div class="input-item input-with-label">
                                    <label for="preconversion_end" class="input-item-label">{{ __('Conversion Right End Date') }}</label>
                                    <div class="input-wrap">
                                        <input class="input-bordered date-picker" type="text" id="preconversion_end" name="preconversion_end" date-format="alt" />
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        (function($) {
            ...
            $("#chvotingright").click( function(e){
                if($("#chReserveRight").is(':checked')==false && $("#chvotingright").is(":checked")==false){
                    e.preventDefault();
                    return false;
                }
                showMeetingRight(e);
