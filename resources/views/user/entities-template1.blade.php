        ...
        <div class="col-lg-12 col-xl-11">
            ...
            <div class="card mx-lg-4">
                <div class="card-head has-aside pd-2x">
                    <div style="font-size:1.29em; color:#342d6e"> <b>Entities > {{ $entities->entity_name }}
                            {{ $entities->check_entype->aabrev_short }} ></b> <span style="font-size:0.8em">
                            {{ __('Complete Configuration') }}</span></div>
                ...
                <form method="POST" action="{{ route('user.entities.add.purpose_activites') }}" autocomplete="off"
                    id="formid">
                    @csrf
                    ...
                    <div class="form-step form-step1">
                        ...
                        <div class="form-step-fields card-innr">
                                ...
                                <div class="col-md-6">
                                    <div class="input-item input-with-label">
                                        <label for="purpose_type"
                                            class="input-item-label">{{ __('Entity Purpose Type') }}</label>
                                        <div class="input-wrap">
                                            <select class="select-bordered select-block" name="purpose_type"
                                                id="purpose_type" data-dd-class="search-on" required>
                                                <option value="" default>{{ __('Select Option') }}</option>
                                                <option value="personal_holding">{{ __('Personal Holding Company') }}
                                                </option>
                                                <option value="commercial_holding">{{ __('Commercial Holding Company') }}
                                                </option>
                                                <option value="operating_company">{{ __('Operating Company') }}</option>
                                                <option value="spv">{{ __('Single Purpose Vehicle') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-item input-with-label">
                                        <label for="trading_name"
                                            class="input-item-label">{{ __('Trading Names') }}</label>
                                        <div class="input-wrap">
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex justify-content-between pdt-1x">
                                        ...
                                        <a href="#" class="btn btn-primary btn-sm" data-toggle="modal"
                                            ...
                                            <em class="fas fa-plus-circle"></em><span>
                                                {{ __('Add Business Activity') }}</span>
                                        </a>
                                    </div>
                                            ...
                                            @foreach ($business as $busi)
                                                <tr class="data-item ">
                                                    <td class="data-col dt-user">
                                                        <span
                                                            class="lead user-name">{{ $busi->get_division->division_label }}</span>
                                                    </td>
                                                    <td class="data-col dt-user">
                                                        <span
                                                            class="lead user-name">{{ $busi->get_group->group_label }}</span>
                                                    </td>
                                                    <td class="data-col dt-user">
                                                        <span
                                                            class="lead user-name">{{ $busi->get_class->class_label }}</span>
                                                    </td>
                                                    <td class="data-col dt-user">
                                                        <span
                                                            class="lead user-name">{{ $busi->get_subclass->subclass_label }}</span>
                                                    </td>
                                                                ...
                                                                <ul class="dropdown-list more-menu-{{ $busi->id }}">
                                                                    <li>
                                                                        <a href="#" data-toggle="modal"
                                                                            ...
                                                                            data-id="{{ $busi->id }}"
                                                                            data-division="{{ $busi->division_id }}"
                                                                            data-group="{{ $busi->group_id }}"
                                                                            data-class="{{ $busi->class_id }}"
                                                                            data-subclass="{{ $busi->subclass_id }}"
                                                                            data-percent="{{ $busi->percent }}"
                                                                            class="user-action front editJurisdiction"> <em
                                                                                class="fas fa-edit"></em>Edit
                                                                        </a>
                                                                        <a href="#" data-uid="{{ $busi->id }}"
                                    ...
                                    <div class="input-item  input-with-label text-area">
                                        <label for="description" class="input-item-label">
                                            ...
                                            <p>Describe here what products/services the new Company will offer, to who, and
                                                how. Use 8 words minimum.</p>
                                        </label>
                                        <div class="input-wrap">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-12 business_model">
                                        ...
                                        <div class="input-item text-left">
                                            <div class="input-wrap">
                                                <input class="input-checkbox input-checkbox-sm" type="checkbox" id='import'
                                                    name="import">
                                                <label
                                        ...
                                        <div class="input-item text-left">
                                            <div class="input-wrap">
                                                <input class="input-checkbox input-checkbox-sm" type="checkbox" id='export'
                                                    name="export">
                                                <label
                            ...
                            {{-- <div class="row">
                                <div class="col-md-6">
                                    <p>{{ __('Will the Company be providing any kind of Financial (Advisory) Services to Third-Parties?') }}
                                    </p>
                                    <div class="input-item input-with-label">
                                ...
                                <div class="col-md-6">
                                    <p>{{ __('Will the Company be active as an Employment-, Secondment-, or Placement Agency?') }}
                                    </p>
                                    <div class="input-item input-with-label">
                                        <div class="input-wrap input-wrap-switch">
                                            <span class="align-items-center d-flex pr-3">Yes</span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <p>{{ __('Will the company be providing any kind of Financial (Advisory) Services…') }}
                                    </p>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-item input-with-label">
                                        <div class="input-wrap input-wrap-switch">
                                            ...
                                            <input class="input-switch" name="financial_service" type="checkbox"
                                                id="financial_service">
                                            <label for="financial_service">No</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <p>{{ __('Will the Company be active as an Employment…') }}
                                    </p>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-item input-with-label">
                                        <div class="input-wrap input-wrap-switch">
                                            <span class="align-items-center d-flex pr-3">{{ __('Yes') }}</span>
                                            <input class="input-switch" name="employment_agency" type="checkbox"
                                                id="employment_agency">
                                            <label for="employment_agency">No</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <p>{{ __('To the best of your knowledge, do the Business Activities of this Company require any operating licenses, permits, or certificates?') }}
                                    </p>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-item input-with-label">
                                        <div class="input-wrap input-wrap-switch">
                                            <span class="align-items-center d-flex pr-3">{{ __('Yes') }}</span>
                                            <input class="input-switch switch-toggle" data-switch="switch-to-yes"
                                                name="regulatory_approvals" type="checkbox" id="regulatory_approvals">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="switch-content switch-to-yes">
                                        <div class="input-item input-with-label">
                                            <label for="txt_namely"
                                                class="input-item-label">{{ __('Please explain') }}</label>
                                            <div class="input-wrap">
                                                <input type="text" class="input-bordered" placeholder="Input text"
                                                    id="txt_namely" name="txt_namely">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex justify-content-between pdt-1x">
                                        <a href="javascript:void(0)"
                                            class="btn btn-primary">{{ __('Previous Step') }}</a>
        ...
        <div class="modal-dialog modal-dialog-md modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="popup-body popup-body-md">
                    ...
                    <form action="{{ route('user.ajax.change.business_activities') }}" method="POST"
                        class="adduser-form validate-modern" id="addBusinessForm" autocomplete="off">
                        @csrf
                                ...
                                <div class="input-item input-with-label">
                                    ...
                                    <select name="division" class="form-control" required="required">
                                        ...
                                        @foreach ($divisions as $division)
                                            <option value="{{ $division->id }}">{{ $division->division_label }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="input-item input-with-label">
                                    ...
                                    <select name="group" class="form-control" required="required">
                                        ...
                                        @foreach ($groups as $group)
                                            <option value="{{ $group->id }}" data-id="{{ $group->division_id }}">
                                ...
                                <div class="input-item input-with-label">
                                    ...
                                    <select name="class" class="form-control" required="required">
                                        ...
                                        @foreach ($classes as $class)
                                            <option value="{{ $class->id }}" data-id="{{ $class->group_id }}">
                                                {{ $class->class_label }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="input-item input-with-label">
                                    ...
                                    <select name="subclass" class="form-control" required="required">
                                        ...
                                        @foreach ($subclasses as $subclass)
                                            <option value="{{ $subclass->id }}" data-id="{{ $subclass->class_id }}">
                                                {{ $subclass->subclass_label }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="input-item input-with-label">
                            ...
                            <div class="input-wrap">
                                <input name="percent" class="input-bordered percent" required="required" type="text"
        ...
        <div class="modal-dialog modal-dialog-md modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="popup-body popup-body-md">
                    ...
                    <form action="{{ route('user.ajax.change.business_activities') }}" method="POST"
                        class="adduser-form validate-modern" id="editBusinessForm" autocomplete="false">
                        @csrf
                        ...
                        <button class="btn btn-md btn-primary"
                            type="submit">{{ __('Change Business Activity') }}</button>
                    </form>
                </div>
            </div>
        </div>
