        ...
        <div class="modal-dialog modal-dialog-md modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="popup-body popup-body-md">
                    ...
                    <form method="POST" class="adduser-form validate-modern" id="addBusinessForm" autocomplete="false">
                        @csrf
                        <div class="row">
        ...
        <div class="modal-dialog modal-dialog-md modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="popup-body popup-body-md">
                    ...
                    <form method="POST" class="adduser-form validate-modern" id="editBusinessForm" autocomplete="false">
                        @csrf
                        <div class="row">
    ...
    <script type="text/javascript">
        (function($) {
            ...
            $('[name="division"]').on('change', function(){
                ...
                $(".group option[value='0']").show().prop('selected', true);
                $("[name='group']").change();
            });
            ...
            $('[name="group"]').on('change', function(){
                ...
                $(".class option[value='0']").show().prop('selected', true);
                $('[name="class"]').change();
            });
            ...
            $('[name="class"]').on('change', function(){
                ...
                $(".subclass option[value='0']").show().prop('selected', true);
